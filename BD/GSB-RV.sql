...
CREATE TABLE FicheFrais (
  ...
  ff_montanthorsclassif numeric(5,2) NOT NULL,
  PRIMARY KEY (ff_mois)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE Motif (
  mot_id int NOT NULL,
  mot_libelle varchar(25),
  mot_precision varchar(50),
  PRIMARY KEY (mot_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE RapportVisite (
  ...
  mot_id int NOT NULL,
  CONSTRAINT CHK_RapportVisite CHECK (rap_coef_confiance<=5 AND rap_coef_confiance>=0),
  PRIMARY KEY (vis_matricule,rap_num)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO RapportVisite VALUES
( 'a131' , 1 , '2018-03-01' , 'RAS' , '2018-03-02' , 1, 22 , 1) ,
( 'a131' , 2 , '2018-04-02' , 'RAS' , '2018-04-03' , 5, 22 , 2) ,
( 'a131' , 3 , '2018-04-03' , 'RAS' , '2018-04-05' , 0, 18 , 1) ,
( 'a131' , 4 , '2018-05-10' , 'RAS' , '2018-05-12' , 2, 22 , 2) ,
( 'a131' , 5 , '2018-05-21' , 'RAS' , '2018-05-25' , 0, 18 , 1) ;
